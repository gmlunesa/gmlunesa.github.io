        ...
        <div className="flex flex-wrap items-stretch justify-center -mx-4">
          {ProjectsData.map((project) => {
            return (
              <a
                key={project.name}
                className="flex w-full mb-8 ml-2 mr-2 sm:px-4 md:w-1/3 lg:w-1/4 lg:mb-0"
                href={project.link}
                target="_blank"
                rel="noopener noreferrer"
              >
                <div className="flex flex-col p-6 rounded shadow sm:p-8 bg-white  dark:bg-gray-900">
                  ...
                  <div className="flex flex-wrap justify-starts items-center mt-4">
                    <div className="text-md mr-2 mt-2 py-1.5 px-4 text-gray-600 bg-rose-100 dark:text-gray-50 dark:bg-rose-900 rounded-2xl">
                      {project.tech}
                    </div>
                  </div>
                </div>
